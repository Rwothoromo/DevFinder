...
import com.example.rwothoromo.developers.adapter.GithubAdapter.ViewHolder
 ...
 */
(private val githubUsers: List<GithubUser>, private val context: Context) : RecyclerView.Adapter<ViewHolder>() {
